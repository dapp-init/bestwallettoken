...
function Navbar() {
  ...
  return (
    <nav className="bg-[#0058bd] px-10 py-2">
      <div className="container mx-auto flex justify-between items-center">
        {/* First Div: Logo and Text */}
        <div className="flex items-center space-x-2">
          <Image src={images.bestwallet} alt="Logo" className="h-8 w-8" />
          <span className="text-2xl text-white font-bold">Best Wallet</span>
        </div>
        ...
        {/* Third Div: Button */}
        <div>
          <button onClick={handleClick} className="bg-transparent text-white text-lg px-8 py-2 rounded-3xl hover:bg-blue-600 border-white border-[1px]">
            Connect a Wallet
          </button>
        </div>
      </div>
